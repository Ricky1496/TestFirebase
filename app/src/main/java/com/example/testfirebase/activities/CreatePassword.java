...
import com.example.testfirebase.databinding.ActivityCreatePasswordBinding;
...
public class CreatePassword extends AppCompatActivity {
    ...
    private void setListeners()
    {
        ...
        binding.gotoSignin.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(),SignInActivity.class)));
        binding.btnCreateAccount.setOnClickListener(v -> {
            if (isValidCreatePasswordDetails())
            {
                createPassword();
            }
        });
    ...
    private void createPassword()
    {
        ...
        user.put(Constants.KEY_ENROLLMENT,binding.inputEnterEnroll.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_ENROLLMENT,documentReference.getId());
    ...
    private Boolean isValidCreatePasswordDetails()
    {
        ...
        else if (binding.inputEnterEnroll.getText().toString().trim().isEmpty()) {
            showToast("Enter Enrollment number");
            return false;
        }
